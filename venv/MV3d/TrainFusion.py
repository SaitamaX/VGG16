...
# validitaion_data has same structure of training_data
...
train_data.extend((data_birdview, data_frontview, data_birdview_rois, data_frontview_rois, data_birdview_box_ind, data_frontview_box_ind,\
